package com.auction.command.api.controller;
...
import com.auction.api.command.producer.BidEventProducer;
import com.auction.command.api.commands.CreateBidCommand;
